...
export const ROUTES: RouteType[] = [
    ...
    {path: STATISTIC_HOURS_PATH, label:'Stataistics Hours', element: <StatisticHours/>},
    {path: STATISTIC_COST_PATH, label: 'Statistics Cost', element: <StatisticsCost/>},
    {path: LOGIN_PATH, label: 'Login', element:<Login/>},
    {path: LOGOUT_PATH, label: 'Logout', element: <Logout/>},
    {path: GENERATION_PATH, label: 'Generation', element: <Generate/>}
]
